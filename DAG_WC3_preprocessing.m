...
% 
% 
% handles.WC.StdThrMU = 3;%5 spike threshold in std's (based on median)
% handles.WC.StdThrSU = 5;%5 spike threshold in std's (based on median)
% 
% % other
