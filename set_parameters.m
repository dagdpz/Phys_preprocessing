...
par.stdmin =300;                      % minimum threshold for detection 
par.stdmax = 1e20;                     % maximum threshold for detection 
par.detect_fmin =1;               % high pass filter for detection 
par.detect_fmax = 12000;              % low pass filter for detection (default 1000) 
par.detect_order = 4;                % filter order for detection 
par.sort_fmin = 1;                 % high pass filter for sorting 
par.sort_fmax = 12000;                % low pass filter for sorting (default 3000) 
par.sort_order = 2;                  % filter order for sorting 
par.ref_ms =1.2;                    % detector dead time, minimum refractory period (in ms) 
